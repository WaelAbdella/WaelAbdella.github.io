...
//typing animation
/*
    var typed = new Typed(".typingintro", {
    strings: ["Hi", "I am", "WAEL AHMED"],
...
document.addEventListener('DOMContentLoaded', function (event) {
  ...
  $('.menu-btn').click(function () {
    $('.Nav-bar').toggleClass('active'); //gives the menu button functionality
    $('.navigation').toggleClass('active'); //gives the menu button functionality
  });
...
*/
  ...
  $(function () {
    ...
    var $horizontalScrollSectionsTriggers =
